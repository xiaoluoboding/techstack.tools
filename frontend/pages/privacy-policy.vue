<template>
  <NuxtLayout name="home">
    ...
    <p>
      ...
      regulatory changes at our discretion. If we decide to modify this privacy
      policy, we will post the changes here at the same link by which you are
      accessing this privacy policy.
    </p>
    <p>
      If required by law, we will get your permission or allow you to opt in to
